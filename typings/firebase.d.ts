...
declare namespace firebase.auth {
  ...
  class EmailAuthProvider extends EmailAuthProvider_Instance {
     ...
     * @return The auth provider credential.
     */
    static credentialWithLink(email: string, emailLink: string): firebase.auth.AuthCredential
  }
  /**
   * @hidden
   */
  ...
  class GoogleAuthProvider extends GoogleAuthProvider_Instance {
    ...
    /**
         ...
         * @return The auth provider credential.
         */
    static credential(idToken?: string | null, accessToken?: string | null): firebase.auth.OAuthCredential
  }
  /**
   * @hidden
   */
  ...
  class OAuthProvider implements firebase.auth.AuthProvider {
     ...
     */
    credential(idToken?: string, accessToken?: string): firebase.auth.OAuthCredential
    /**
  ...
  class PhoneAuthProvider_Instance implements firebase.auth.AuthProvider {
     ...
     */
    verifyPhoneNumber(phoneNumber: string, applicationVerifier: firebase.auth.ApplicationVerifier): Promise<string>
  }
  ...
  class TwitterAuthProvider extends TwitterAuthProvider_Instance {
     ...
     * @return The auth provider credential.
     */
    static credential(token: string, secret: string): firebase.auth.OAuthCredential
  }
  /**
   * @hidden
   */
...
declare namespace firebase.database {
  ...
  interface ThenableReference extends firebase.database.Reference, Promise<Reference> {}
